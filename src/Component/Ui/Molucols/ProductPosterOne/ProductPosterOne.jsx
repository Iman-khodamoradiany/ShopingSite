...
function ProductPosterOne() {
    return (
        <div className="w-1/2 h-[250px] rounded-3xl bg-[url(/Background/BlueBackground.png)] flex justify-between items-center">
            <div>
                <Img className={'w-full'} src={'/Background/Dambel.png'} />
            </div>
            <div className="flex justify-center items-end flex-col px-3 gap-1 mb-5">
