...
function ProductPosterTow() {
    return (
        <div className="w-1/2 h-[200px] rounded-3xl bg-[url(/Background/GreenBackground.png)] flex justify-between px-3 items-center">
            <div>
                <Img className={'w-11/12'} src={'/Background/Travel.png'} />
            </div>
            <div className="flex justify-center items-end px-3 flex-col gap-2">
